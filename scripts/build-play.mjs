...
const body = `<title>엘드리아 연대기 · 방치형 RPG</title>
<style id="expo-reset">html,body{height:100%;margin:0}body{overflow:hidden;background:#1b1430}#root{display:flex;height:100vh;flex:1}</style>
<div id="root"></div>
<script>${js}</script>`;

fs.mkdirSync('docs', { recursive: true });
fs.writeFileSync('docs/play.html', body);
console.log('생성: docs/play.html', (body.length / 1024).toFixed(0) + 'KB');
