...
export const DIFFICULTIES = [
  { id: 'normal', label: '일반', emoji: '🟢', enemyMult: 1, rewardMult: 1, unlock: 1 },
  { id: 'hard', label: '험난', emoji: '🟡', enemyMult: 2, rewardMult: 8, unlock: 30 },
  { id: 'hell', label: '지옥', emoji: '🔴', enemyMult: 4, rewardMult: 40, unlock: 60 },
  { id: 'abyss', label: '나락', emoji: '🟣', enemyMult: 8, rewardMult: 200, unlock: 100 },
];
